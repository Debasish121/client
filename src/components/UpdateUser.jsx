  ...
  return (
    <div className='flex h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 justify-center items-center' style={{ backgroundImage: `url(${bgImage})`, backgroundSize: 'cover' }}>
        <div className="w-full max-w-xs">
            <form className="bg-white bg-opacity-40 backdrop-filter backdrop-blur-lg shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={Update}>
                ...
                <div className="mb-4">
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Phone" 
